...
export class FirstComponent implements OnInit {
  ...
  ngOnInit() {
    // this.registerForm = this.formBuilder.group({
    //   candidateName: ['', [Validators.required, Validators.pattern(this.unamePattern)]],
    //   candidateEmail: ['', [Validators.required, Validators.pattern(this.emailPattern)]],
    //   candidateAddress: ['', [Validators.required, Validators.pattern(this.unamePattern)]],
    //   candidateHighestQualification: ['', [Validators.required, Validators.pattern(this.unamePattern)]],
    //   candidateContactNo: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(16)]],
    //   candidateResume: ['',[Validators.required]],
    //   candidateDateOfBirth: ['', [Validators.required]],
    // });
